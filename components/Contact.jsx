  ...
  return (
    <div id='contact' className='w-full lg:h-screen pt-5'>
      <div className='max-w-[1240px] m-auto px-2 py-16 w-full '>
        ...
        <h2 className='py-4'>To contact</h2>
        <div className='grid lg:grid-cols-5 gap-8'>
          ...
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full '>
              ...
              <div>
                <p className='capitalize pt-8'>Connect With Me</p>
              ...
              <form>
                <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
                  <div className='flex flex-col'>
                    ...
                    <input
                      className='border-2 rounded-lg p-3 flex border-gray-300 hover:border-blue-400'
                      type='text'
                    />
                  </div>
                  <div className='flex flex-col'>
                ...
                <div className='flex flex-col py-2'>
                  ...
                  <textarea
                    className='border-2 rounded-lg p-3 border-gray-300 hover:border-blue-400'
                    rows='10'
                  ></textarea>
                </div>
